...
$count = 0;
  ...
  if ( $query->have_posts() ) {
    ...
    <div class="container" style="padding-top: 50px;">
      ...
      <div class="col-sm-12">
        <h3 class="widget-title">Featured Podcasts</h3>
      </div>
        <?php
        ...
        <div class="col-sm-4">
          ...
          <div class="podcast">
            ...
            <a class="moretag" href="<?php the_permalink(); ?>">Listen to the Podcast</a>
            </div>
          </div>
        </div>
        <?php
...
$count = 0;
  ...
  if ( $query->have_posts() ) {
    ...
    <div class="container">
      <div class="row mx-auto align-items-center">
      <div class="col-sm-12">
        <h3 class="widget-title" style="padding-bottom: 50px;">Latest Posts</h3>
      </div>
        <?php
        while ( $query->have_posts() ) : $query->the_post() ;
...
function homepage_logos() {
  ?>
  <div class="container-fluid" style="background: #fff url(<?php echo the_field('featured_footer_background_image', 'option'); ?>) repeat center top;"><!-- featured section -->
        <div class="row justify-content-center featured-row">

          <div class="col-sm-12">
              <h3>Abhi has been featured in</h3>
...
add_shortcode( 'homepage_logos', 'homepage_logos' );
