...
<div class="row no-gutters align-items-center">
	...
	<div class="col-sm-4 float-right share-buttons hidden-xl-down">
		<a class="custom-share-button js-social-share bg-fb" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(get_the_title()); ?>" target="_blank">
